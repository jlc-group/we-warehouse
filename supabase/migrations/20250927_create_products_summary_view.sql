...
-- Index สำหรับ performance (ถ้าเป็น materialized view)
-- CREATE INDEX IF NOT EXISTS idx_products_summary_sku ON public.products_summary(sku);
-- CREATE INDEX IF NOT EXISTS idx_products_summary_stock_status ON public.products_summary(stock_status);

SELECT '✅ สร้าง products_summary view สำเร็จแล้ว! ใช้ conversion rates ที่ถูกต้องและมี product_type ครบถ้วน' as status;