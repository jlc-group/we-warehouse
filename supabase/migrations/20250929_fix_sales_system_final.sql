...
('บริษัท เฟรช ฟู้ด ซัพพลาย จำกัด', '02-777-8888', 'supply@freshfood.com', '987 ถ.บางนา-ตราด แขวงบางนา เขตบางนา กรุงเทพฯ 10260', 'คุณสุนีย์ สดใส', 'บริษัท เฟรช ฟู้ด ซัพพลาย จำกัด', '5678901234567', 300000.00, 21, 'ซัพพลายเออร์อาหารสด - ต้องการความเย็น'),
...
-- แสดงข้อความสำเร็จ
SELECT 'Sales system tables created successfully!' as status,
