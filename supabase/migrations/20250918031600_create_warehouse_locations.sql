-- Migration: Create warehouse_locations table
-- Description: Table for managing warehouse location positions and capacity
...
ON public.warehouse_locations(location_type);
...
COMMENT ON TABLE public.warehouse_locations IS 'Warehouse location management table with position data and capacity limits';
COMMENT ON COLUMN public.warehouse_locations.location_code IS 'Standardized location code in format A/1/01';
COMMENT ON COLUMN public.warehouse_locations.row IS 'Warehouse row (A-Z)';
COMMENT ON COLUMN public.warehouse_locations.level IS 'Shelf level (1-4)';
COMMENT ON COLUMN public.warehouse_locations.position IS 'Position number (1-99)';
COMMENT ON COLUMN public.warehouse_locations.location_type IS 'Type of location: shelf, floor, or special';
COMMENT ON COLUMN public.warehouse_locations.capacity_boxes IS 'Maximum capacity for boxes';
COMMENT ON COLUMN public.warehouse_locations.capacity_loose IS 'Maximum capacity for loose items';