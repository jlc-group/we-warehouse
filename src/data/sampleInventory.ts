...
const chulaherb_products = [
  ...
  { name: "จุฬาเฮิร์บ เมลอน มิลก์ ยูวี เอสเซนส์ 30 ก", code: "C3-7G" },
  ...
  { name: "จุฬาเฮิร์บ วอเตอร์เมลอน อีอี คูชั่น 02 30 ก.หลอด", code: "L8B-6G" },
  ...
  { name: "จุฬาเฮิร์บ มาสก์ ลำไยทองคำ 24 ก.", code: "M2-4G" },
  ...
  { name: "จุฬาเฮิร์บ แบล็ก จิงเจอร์ เคลีย เซรั่ม 40ก หลอด", code: "C4-40G" },
