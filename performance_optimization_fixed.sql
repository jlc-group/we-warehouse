-- 🚀 Performance Optimization for Warehouse Location Management (Fixed)
...
-- รองรับ location format หลากหลาย โดยใช้ normalize_location_format function
-- (หมายเหตุ: function normalize_location_format ต้องรันก่อนใน complete_database_setup.sql)
