-- คำสั่ง SQL สำหรับสร้างตาราง product_conversion_rates ใน Supabase (แก้ไข error)
...
DROP POLICY IF EXISTS "Allow all operations on product_conversion_rates" ON public.product_conversion_rates;
...
DROP TRIGGER IF EXISTS update_product_conversion_rates_updated_at ON public.product_conversion_rates;
...
-- เพิ่มข้อมูลตัวอย่าง (หากยังไม่มี)
